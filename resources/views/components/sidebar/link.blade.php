...
@php
    $isActiveClasses =  $isActive ? 'text-white bg-neutral shadow-lg hover:bg-neutral' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:text-gray-300 dark:hover:bg-white-eval-2';
